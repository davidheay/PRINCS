                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 alertWrapper clerfix">
                                                <a href="/PRINCS/consultaMercanciaController">
                                                    ...
                                                    <br>
                                                    <button id="basic" class="btn btn-primary btn-df float-button-light md-trigger waves-effect waves-button waves-float waves-light" data-modal="modal-1">Consultar Mercancía</button>
                                                </a>
                                            </div>
                                            <div class="col-lg-3 alertWrapper">
                                                <a href="menuinventario.html">
                                                    ...
                                                    <br>
                                                    <button id="titleWithText" class="btn btn-primary btn-df float-button-light md-trigger waves-effect waves-button waves-float waves-light" data-modal="modal-1">Consultar Inventario</button>
                                                </a>
                                            </div>
                                            <div class="col-lg-3 alertWrapper">
                                                <a href="manalisis.html">
                                                    ...
                                                    <br>
                                                    <button id="successMessage" class="btn btn-primary btn-df float-button-light md-trigger waves-effect waves-button waves-float waves-light" data-modal="modal-1">Analizar Inventario</button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
