                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <div class="panel-heading-title pull-left">
                                        ...
                                        <h7>Seleccione el tipo de análisis que desea realizar</h7>
                                    </div>
                                    <!--panel-heading-title-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 alertWrapper clerfix">
                                            <a href="analisisbodega.jsp">
                                                <div class="enBodega">
                                                    <center>
                                                        <img src="img/enbodega.jpg" alt=""/>
                                                    </center>
                                                </div>
                                                <br>
                                                <button id="bodega" class="btn btn-primary btn-df float-button-light md-trigger waves-effect waves-button waves-float waves-light" data-modal="modal-1">Uso de Bodega</button>
                                            </a>
                                        </div>
                                        <div class="col-lg-3 alertWrapper">
                                            <a href="analisisflujo.jsp">
                                                <div class="flujo">
                                                    <center>
                                                        <img src="img/entradasalida.jpg" alt=""/>
                                                    </center>
                                                </div>
                                                <br>
                                                <button id="titleWithText" class="btn btn-primary btn-df float-button-light md-trigger waves-effect waves-button waves-float waves-light" data-modal="modal-1">Flujo de entrada y salida</button>
                                            </a>
                                        </div>
                                        <div class="col-lg-3 alertWrapper">
                                            <a href="analisistipo.jsp">
                                                ...
                                                <br>
                                                <button id="successMessage" class="btn btn-primary btn-df float-button-light md-trigger waves-effect waves-button waves-float waves-light" data-modal="modal-1">Tipo de carga</button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
