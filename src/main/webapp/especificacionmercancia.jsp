...
<html lang="en">
    ...
    <head>
        ...
        <title>Especificación Mercancía </title>
                                        ...
                                        <div class="panel-body">
                                            <div class="titulo" style="align-content: center">
                                                ...
                                                <div class="input-group input-default">
                                                    ...
                                                    <input type="text" value="<%= request.getAttribute("idMercancia")%>" readonly=»readonly» class="form-control" placeholder="ID Mercancía" aria-describedby="basic-addon1">
                                                </div>
                                                <br>
                                                <LABEL>ESTADO</LABEL>
                                                <br>
                                ...
                                <div class="col-lg-6 ">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <div class="input-group input-default">
                                                <span class="input-group-addon border-left" id="basic-addon3"></span>
                                                <input type="text" value="<%= request.getAttribute("tipo")%>" readonly=»readonly» class="form-control" placeholder="Tipo de Mercancía " aria-describedby="basic-addon1">
                                            </div>
                                            <br>
                                            <LABEL>CLIENTE</LABEL>
                                            <br>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <div class="buttonWrapper" style="padding: inherit" >
                                                ...
                                                <c:set var="variable" scope="session" value="${reservaIn}"/>
                                                <c:if test = "${variable != 'NULL'}">
                                            ...
                                            <div class="buttonWrapper" style="padding: inherit" >
                                                ...
                                                <c:set var="variable1" scope="session" value="${reservaOut}"/>
                                                <c:if test = "${variable1 != 'NULL'}">
                                                    <form action="/PRINCS/actaController" method="POST">
                                                        <input type="hidden" id="idActa" name="idActa" value="<%= request.getAttribute("reservaOut")%> " >
                                                        <button type="submit" class="btn btn-info btn-df  float-button-light">Ver</button>
                                                    </form>
                                                </c:if>
                                                <br>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="input-group input-primary-light">
                                                <input type="text" value="<%= request.getAttribute("nPiezas")%>" readonly=»readonly» class="form-control" placeholder="Número de piezas" aria-describedby="basic-addon8">
                                            ...
                                            <br>
                                            <div class="input-group input-primary-light">
                                                <input type="text" value="<%= request.getAttribute("valor")%>" readonly=»readonly» class="form-control" placeholder="Valor de la mercancía" aria-describedby="basic-addon8">
                                                <span class="input-group-addon" id="basic-addon8"></span>
                                            </div>
                                            <LABEL>MONEDA</LABEL>
                                            <br>
